...
def get_model():
    ...
    bert_model3 = build_bert_model(
        config_path,
        checkpoint_path,
        albert=True
    )
    bert_mdoel4 = build_bert_model(
        config_path,
        checkpoint_path,
        albert=True
    )
...
oof_test /= 5
np.savetxt('./model_save/train_bert_bert4.txt', oof_train)
np.savetxt('./model_save/test_bert_bert4.txt', oof_test)
